  ...
  async listTransportBookings(): Promise<Booking[]> {
    if (isSupabaseConfigured()) {
      ...
      return (data ?? []).map((b: any) => ({
        ...
        flightDate: b.flight_date ?? null,
        flightVerified: b.flight_verified ?? false,
        flightStatus: b.flight_status ?? null,
        flightAirline: b.flight_airline ?? null,
        flightDepartureIata: b.flight_departure_iata ?? null,
        flightArrivalIata: b.flight_arrival_iata ?? null,
